...
export const resetSettingsToDefaults = async (deps) => {
  const {
    ...
    setOsuFolderPath: _setOsuFolderPath,
    ...
    setVuEnabled,
    setShowSongBadges,
    clearRecentlyPlayed: _clearRecentlyPlayed,
    setFavorites: _setFavorites,
    clearPlayCounts: _clearPlayCounts,
    setDurationFilter,
    setMinDurationValue,
    setItemsPerPage,
    setHiddenArtists,
