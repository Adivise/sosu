...
### Windows Users
- Click [here](https://github.com/Adivise/sosu/releases/latest/download/sosu-2.6.0.exe) to download the recommended Windows installer
- Alternative downloads from the [latest release](https://github.com/Adivise/sosu/releases/latest):
  - **Portable (.exe)**
    - `sosu-2.6.0-portable.exe` (no installation required)
  - **MSI Installer (.msi)**
    - `sosu-2.6.0.msi` (alternative for enterprise environments)
...
- Click [here](https://github.com/Adivise/sosu/releases/latest/download/sosu-2.6.0.dmg) to download the recommended macOS installer
- Alternative downloads from the [latest release](https://github.com/Adivise/sosu/releases/latest):
  - **PKG Installer (.pkg)**
    - `sosu-2.6.0.pkg` (for Apple Silicon Macs)
...
- Click [here](https://github.com/Adivise/sosu/releases/latest/download/sosu-2.6.0.AppImage) to download the recommended Linux AppImage
- Alternative downloads from the [latest release](https://github.com/Adivise/sosu/releases/latest):
  - **Debian Package (.deb)**
    - `sosu_2.6.0.deb`
  - **RPM Package (.rpm)**
    - `sosu-2.6.0.rpm`
  > *You may need to make the AppImage executable: `chmod +x ./sosu-2.6.0.AppImage` and then run it.*
